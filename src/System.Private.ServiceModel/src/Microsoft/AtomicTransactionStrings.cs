namespace Microsoft.Transactions.Wsat.Messaging
{
    internal abstract class AtomicTransactionStrings
    {
        ...
        public abstract string AbortedAction
        {
            get;
        }
        ...
        public abstract string CommitAction
        {
            get;
        }
        ...
        public abstract string CommittedAction
        {
            get;
        }
        ...
        public abstract string CompletionUri
        {
            get;
        }
        ...
        public abstract string Durable2PCUri
        {
            get;
        }

        public abstract string FaultAction
        {
            get;
        }
        ...
        public abstract string PrepareAction
        {
            get;
        }
        ...
        public abstract string PreparedAction
        {
            get;
        }
        ...
        public abstract string ReadOnlyAction
        {
            get;
        }
        ...
        public abstract string RollbackAction
        {
            get;
        }
        ...
        public abstract string Volatile2PCUri
        {
            get;
        }
