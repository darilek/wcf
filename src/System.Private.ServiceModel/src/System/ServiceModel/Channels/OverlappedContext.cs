...
namespace System.ServiceModel.Channels
{
    ...
    unsafe class OverlappedContext
    {
        ...
        public OverlappedContext()
        {
            ...
            {
                OverlappedContext.completeCallback = Fx.ThunkCallback(CompleteCallback);
            }
            if (OverlappedContext.eventCallback == null)
            {
                OverlappedContext.eventCallback = Fx.ThunkCallback(EventCallback);
            }
            if (OverlappedContext.cleanupCallback == null)
            {
                OverlappedContext.cleanupCallback = Fx.ThunkCallback(CleanupCallback);
            }
