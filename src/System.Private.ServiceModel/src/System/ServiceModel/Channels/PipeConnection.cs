  ...
  //  using System.ServiceModel.Diagnostics.Application;
    ...
    sealed class PipeConnection : IConnection
    {
        ...
        public PipeConnection(PipeHandle pipe, int connectionBufferSize, bool isBoundToCompletionPort, bool autoBindToCompletionPort)
        {
            ...
            this.asyncReadBuffer = Fx.AllocateByteArray(connectionBufferSize);
        ...
        public unsafe AsyncCompletionResult BeginRead(int offset, int size, TimeSpan timeout, WaitCallback callback, object state)
        {
                ...
                if (connection == null)
                {
                    ...
                    if (DiagnosticUtility.ShouldTraceInformation)
                    {
                        TraceUtility.TraceEvent(
                            ...
                            SR.GetString(SR.TraceCodeFailedPipeConnect, timeoutHelper.RemainingTime(), remoteUri));
                    }
                }
            }
            return connection;
